...
public class end_room_dialog extends AppCompatActivity {
...
//    Dialog dilaog03; //다이얼로그2
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dilaog02 = new Dialog(end_room_dialog.this); //다이얼로그 초기화
...
//        dilaog03 = new Dialog(end_room_dialog.this); //다이얼로그 초기화
...
//        dilaog03.setContentView(R.layout.activity_goout_dialog); //레이아웃 연결
            ...
            public void showDialog02() {
                ...
                endBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(end_room_dialog.this, HomeActivity.class);
        ...
        cancel_button.setOnClickListener(new View.OnClickListener() { // 나가기 창
            ...
            public void showDialog03() {
                ...
                Button CancelBtn = dilaog02.findViewById(R.id.cancel_button);
